classdef SequenceExecution
  %SEQUENCEEXECUTION Summary of this class goes here
  ...
  methods
    function obj = SequenceExecution()
      %SEQUENCEEXECUTION Construct an instance of this class
      %   Detailed explanation goes here
    end
