...
function tests = BinarizeInvertTest
...
function TestDefaultCommand(testCase)
  ...
  [~, ~, actualCommand] = BinarizeInvert(pathToWorkspace, configCell{:});
  ...
  expectedCommand = sprintf('fslmaths %s -binv %s', inputfile, outputfile);
