...
function tests = ComputeMeanVolumeTest
...
function TestDefaultCommand(testCase)
  ...
  [~, ~, actualCommand] = ComputeMeanVolume(pathToWorkspace, configCell{:});
  ...
  expectedCommand = sprintf('fslmaths %s -Tmean %s', inputfile, outputfile);
